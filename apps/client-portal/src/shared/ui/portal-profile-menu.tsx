...
import { usePortalProfileMenu } from "@/shared/hooks/usePortalProfileMenu";
import { MenuRow } from "./menu-row";

export const PortalProfileMenu = () => {
  const { open, setOpen, close, name, email, goToProfile, handleLogout } =
    usePortalProfileMenu();
  ...
  return (
    ...
    >
      <Container className="flex items-center gap-2 cursor-pointer">
        <Container className="w-8 h-8 rounded-full bg-brand-tertiary-bg-bold flex items-center justify-center shrink-0">
