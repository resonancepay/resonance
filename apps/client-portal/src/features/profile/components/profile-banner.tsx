  ...
  return (
    <Container className="bg-surface relative border-[0.5px] border-brand-secondary-border p-3.5 rounded-xl">
      <Container className="flex items-center gap-3">
        <Container className="w-16 h-16 rounded-full bg-brand-tertiary-bg-bold flex items-center justify-center shrink-0">
      ...
      <Container className="absolute right-0 bottom-0">
        <Image
          src="/assets/svgs/profile-character.svg"
          alt=""
          width={107}
          height={76}
          className="w-14 h-auto lg:w-auto"
        />
      </Container>
    </Container>
  );
